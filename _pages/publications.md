...
title: publications
description: Publications in reverse chronological order.<br> note&#58 * indicates equal contributions. † indicates that the author ordering is alphabetical.
...
<div class="btn-group btn-group-sm mb-3" role="group" aria-label="Grouping toggle">
  ...
  <button id="btn-group-type" type="button" class="btn btn-outline-primary">By venue type</button>
</div>
